...
<DropdownMenu.Root bind:open={menuDropdownOpen}>
  <DropdownMenu.Trigger class="hover:bg-popover group flex items-center gap-2 rounded-md px-4 py-2">
    <img class="pointer-events-none block h-8 w-auto transition-transform duration-300 ease-in-out group-data-[state=open]:rotate-45 max-md:group-data-[state=open]:-rotate-45" src="/assets/favicons/favicon.png" alt="MinionAH Logo" />
